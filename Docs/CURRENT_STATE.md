...
| Governance status | Build 8 migration, Plan/analytics, Local Day/lifecycle truth and the P0/P1 period-aware dashboard are locally verified; the branch is not ready for review or distribution |
