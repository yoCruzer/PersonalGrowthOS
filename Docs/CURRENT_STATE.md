...
| Governance status | Build 8 migration, Plan/analytics, Local Day/lifecycle truth, P0/P1 dashboard, backup boundary and bilingual Dashboard are locally verified; the branch is not ready for review or distribution |
