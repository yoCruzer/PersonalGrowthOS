...
| Governance status | Build 8 PR #5 review closure complete; automated gate passed and Owner device validation remains mandatory |
...
| Final automated gate | Build 8 review closure: 196/196 Unit, 31/31 UI and Debug PASS; targeted Habit/ImportExport/UI plus prior exact-V7 overlay/reopen and bilingual evidence remain green |
