...
| Governance status | Build 8 feature scope and frozen Habit-row UI/accessibility carryover are locally verified; the branch is not ready for review until the complete gate passes |
